...
export class tablesCreated1649960640658 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "admins" ("id_admin" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "isAdm" boolean NOT NULL, CONSTRAINT "UQ_051db7d37d478a69a7432df1479" UNIQUE ("email"), CONSTRAINT "PK_0827102ceb21bbf3896a75b6291" PRIMARY KEY ("id_admin"))`);
        await queryRunner.query(`CREATE TABLE "sales" ("id_sale" uuid NOT NULL DEFAULT uuid_generate_v4(), "sold_at" TIMESTAMP NOT NULL, "expires_in" TIMESTAMP NOT NULL, "closed" boolean NOT NULL DEFAULT false, "userIdUser" uuid, "customerIdCustomers" uuid, CONSTRAINT "PK_14df41ad90010de4de26f35e9bf" PRIMARY KEY ("id_sale"))`);
        ...
        await queryRunner.query(`ALTER TABLE "sales" ADD CONSTRAINT "FK_ac2a482773ccbb064dd6d77fc98" FOREIGN KEY ("customerIdCustomers") REFERENCES "customers"("id_customers") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "customers" ADD CONSTRAINT "FK_aed68855b8d1b6b011285a8c8bf" FOREIGN KEY ("userIdUser") REFERENCES "users"("id_user") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "customers" DROP CONSTRAINT "FK_aed68855b8d1b6b011285a8c8bf"`);
        ...
        await queryRunner.query(`ALTER TABLE "sales" DROP CONSTRAINT "FK_ac2a482773ccbb064dd6d77fc98"`);
